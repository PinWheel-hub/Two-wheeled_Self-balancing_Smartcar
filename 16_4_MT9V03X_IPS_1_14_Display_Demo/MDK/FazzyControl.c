...
#define FMAX    100      
     /*语言值的满幅值*/ 
int PFF[4]={0,15,30,45};
      /*输入量D语言值特征点*/ 
int DFF[4]={0,20,40,60};
      /*输出量U语言值特征点*/ 
int UFF[7]={0,150,300,450,600,750,900};
 ...
 int rule[7][7]={ 
      ...
      /**********************************************************/
int  Fuzzy(int aver_error,Fuzzy_input* Turn)   /*模糊运算引擎*/ 
   { 
      ...
      int P,D;
		  ...
		  Turn->P_Error=aver_error;
      P=Turn->P_Error;
      D=Turn->P_Error-Turn->P_Error_last;	 
      ...
      U=temp1/temp2;
		  ...
		  Turn->P_Error_last=Turn->P_Error;
